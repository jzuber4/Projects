...
[**Find PI to the Nth Digit**](https://github.com/jzuber4/Projects/blob/master/Numbers/pi.py) – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/jzuber4/Projects/blob/master/Numbers/fibonacci.py) – Enter a number and have the program generate the Fibonacci sequence to the Nth number.

[**Prime Factorization**](https://github.com/jzuber4/Projects/blob/master/Numbers/factor.py)– Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/jzuber4/Projects/blob/master/Numbers/next_prime.py) – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/jzuber4/Projects/blob/master/Numbers/tile.py) – Calculate the total cost of tile it would take to cover a floor plan of width, height and cost entered by the user.

[**Mortgage Calculator**](https://github.com/jzuber4/Projects/blob/master/Numbers/mortgage.py) – Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate.

[**Change Return Program**](https://github.com/jzuber4/Projects/blob/master/Numbers/change.py) – The user enters a cost and then the amount of money given. The program will figure out the change and the number of (different denomination) dollar bills, quarters, dimes, nickels, pennies needed for the change.
